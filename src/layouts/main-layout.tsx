  ...
  return (
    <div className="flex flex-col h-screen bg-slate-950 text-slate-200 overflow-hidden">
      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        <aside
          className={`bg-slate-900 text-slate-100 flex flex-col fixed md:static z-20 w-64 transition-all duration-300 ease-in-out transform ${sidebarOpen ? 'translate-x-0 h-[calc(100vh-64px)] top-[64px] md:top-0 md:h-full' : '-translate-x-full md:translate-x-0 md:w-20 h-full'
            }`}
        >
                    ...
                    {canViewProducts && (
                      <>
                        <NavLink
                          ...
                          className={({ isActive }) => [
                            'flex items-center gap-3 pl-8 pr-4 py-2 text-sm transition-colors',
                            isActive && !window.location.pathname.includes('/config/templates') ? 'bg-blue-600 text-white border-r-2 border-blue-400' : 'text-slate-300 hover:bg-slate-700 hover:text-white',
                            sidebarOpen ? '' : 'md:pl-0 md:pr-0 md:justify-center md:gap-0',
                          ].join(' ')}
                          end
                        >
                        ...
                        <NavLink
                          to="/main/products/config/templates"
                          onClick={closeSidebarOnMobile}
                          className={({ isActive }) => [
                            'flex items-center gap-3 pl-8 pr-4 py-2 text-sm transition-colors',
                            isActive ? 'bg-blue-600 text-white border-r-2 border-blue-400' : 'text-slate-300 hover:bg-slate-700 hover:text-white',
                        ...
                        >
                          ...
                          <span className={sidebarOpen ? '' : 'md:hidden'}>Tipos de Producto</span>
                        </NavLink>
                      </>
                    )}
                  </div>
